...
from Lovechat.modules.helpers import CHATBOT_ON, is_admins


@Lovechat.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        Chikudb = MongoClient(MONGO_URL)
        Chiku = Chikudb["ChikuDb"]["Chiku"]
        is_Chiku = Chiku.find_one({"chat_id": message.chat.id})
        if not is_Chiku:
